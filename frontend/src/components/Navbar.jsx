        ...
        <div className="relative z-10 flex justify-between items-center w-full max-w-7xl mx-auto">
          ...
          <Link to="/" className="flex-shrink-0"> 
            <div className="flex items-center gap-3">
              ...
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full overflow-hidden border-2 border-purple-400/50 shadow-lg hover:border-purple-400 transition-all hover:scale-105">
                <img 
              ...
              <div className="h-8 sm:h-10 w-auto rounded-lg overflow-hidden shadow-lg hover:scale-105 transition-all bg-white">
                <img 
